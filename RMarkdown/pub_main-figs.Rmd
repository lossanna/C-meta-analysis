...
- Note that the word "exotic" is used to refer to the non-native dataset and models in the code, but has been replaced with "non-native" in the figures.
...
# Figure 1
Figure 1 is an orchard plot to display the results of the non-native and native summary models.
```{r, eval=FALSE}
...
f1.df <- data.frame(model = c("Non-native", "Native"),
...
# Figure 2
Figure 2 is a forest plot of non-native weed response by study duration (months from first C app to harvest).
```{r, eval=FALSE}
# Exotic dlc model
...
# Figure 3
Figure 3 is a forest plot of non-native weed response by plant lifeform (annual/perennial and grass/forb/shrub).
```{r, eval=FALSE}
