...
- Analysis includes a model run with all the data, and a model run with outliers removed (see "Native outliers for models" document for details; `code_native-outliers.html`).
