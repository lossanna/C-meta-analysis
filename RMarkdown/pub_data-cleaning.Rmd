...
# Introduction
- This document details data cleaning and calculating effect size for both the non-native and native datasets.
- See "Non-native (exotic) single moderator models" and "Native single moderator models" documents for more details on transformation of continuous variables to categorical variables (`code_nonnative-moderator-analysis.html`, `code_native-moderator-analysis.html`).
