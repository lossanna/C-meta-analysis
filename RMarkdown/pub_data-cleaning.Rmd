...
- See "Non-native (exotic) single moderator models" and "Native single moderator models" documents for more details on transformation of continuous variables to categorical variables (`pub_ex-1mod.html`, `pub_nt-1mod.html`).
