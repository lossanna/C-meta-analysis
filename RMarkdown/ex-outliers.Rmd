...
- 2022-05-24 small update: changed syntax of `df$new <- NA` to `df$new <- NA` because the previous is no longer supported and won't actually create a new empty column.
