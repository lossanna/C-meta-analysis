...
- Analysis includes a model run with all the data, and a model run with outliers removed (see "Non-native (exotic) outliers for models" document for details; `pub_ex-outliers.html`).
