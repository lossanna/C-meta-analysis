...
f1.orc.ex <- orchard_plot(ex.mv.o, mod = "Int", xlab = "Effect size (Hedges' g)", transfm = "none") +
  ggtitle("Non-native weed summary response") +
...
par(cex = 0.75, font = 2)
text(x = 0, y = 11, labels = "Non-native weed response")
dev.off()
...
par(cex = 0.75, font = 2)
text(x = 0, y = 6, labels = "Non-native weed response")
dev.off()
...
par(cex = 0.75, font = 2)
text(x = 0, y = 16.1, labels = "Non-native weed response")
dev.off()
